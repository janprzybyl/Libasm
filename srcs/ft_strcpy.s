...
copy:
		...
		; You can't copy the BYTE value to 64-bit register. You need to use 8-bit register (in that case it's dl register).
		...
		mov	dl, BYTE [rsi + rax]	; copy given byte from src parameter to dl register
